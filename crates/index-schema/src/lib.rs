...
mod schema {
    ...
    static MIGRATIONS: LazyLock<Migrations<'static>> = LazyLock::new(|| {
        Migrations::new(vec![
            ...
            M::up(include_str!("../migrations/0021_search_fts_identity.sql")),
            M::up(include_str!("../migrations/0022_embedding_state.sql")),
            M::up(include_str!("../migrations/0023_note_projection_path.sql")),
        ])
    });
