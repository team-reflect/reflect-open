 ...
 * Subdomain wildcards cover `www.`/`mobile.` (a match pattern `*.x.com`
 * matches `x.com` itself too); `twitter.com` still redirects to `x.com`, but
 * a bookmark made before the redirect lands must be watchable too.
 */
