 ...
 *
 * Without a transcription-capable model the sheet shows key-setup guidance instead
  ...
  return (
    <div className="flex flex-col items-center gap-4 px-4 pb-2 text-center">
      <p className="text-sm text-text-muted">
        Audio memos send the recording to your transcription provider for transcription into your
