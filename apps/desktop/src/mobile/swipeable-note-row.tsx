  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="absolute inset-0 flex w-full flex-col justify-center gap-0.5 overflow-hidden bg-background px-4 text-left not-data-dragging:active:opacity-70"
        style={{ height: NOTE_ROW_HEIGHT }}
      >
