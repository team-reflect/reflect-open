...
/** Loads templates when the picker opens and inserts into the targeted note. */
export function TemplatePickerContent({ context }: TemplatePickerContentProps): ReactElement {
  ...
  return (
    <Command>
      <CommandInput autoFocus placeholder="Insert template…" />
      <CommandList>
