...
/** Resolves attendees and writes the selected calendar event into the daily note. */
export function AddMeetingForm({ date, event, onClose }: AddMeetingFormProps): ReactElement {
