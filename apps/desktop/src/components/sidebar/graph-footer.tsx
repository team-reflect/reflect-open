  ...
  return (
    ...
    >
      {open ? (
        <>
          ...
          <div
            ...
            className="absolute inset-x-0 bottom-full z-30 mb-1.5 rounded-lg border border-[var(--border)] bg-[var(--surface)] p-1 shadow-[var(--shadow-pop)]"
          >
            {recents.map((recent) => {
              ...
              return (
                <button
                  ...
                  className="flex w-full items-center gap-2 rounded-md px-2 py-1.5 text-[13px] text-[color:var(--text-secondary)] hover:bg-[var(--surface-hover)] hover:text-[color:var(--text)]"
                >
                  <span className="min-w-0 flex-1 truncate text-left">{recent.name}</span>
                  {current ? (
                    <Check aria-hidden className="size-3.5 shrink-0 text-[color:var(--accent)]" />
                  ) : null}
                </button>
              )
            })}
            {recents.length > 0 ? (
              <div role="separator" className="mx-2 my-1 border-t border-[var(--border)]" />
            ) : null}
            <button
              type="button"
              role="menuitem"
      ...
      <button
        ...
        className="flex w-full items-center gap-2.5 rounded-md px-2 py-1.5 text-left transition-colors duration-100 hover:bg-[var(--surface-hover)]"
      >
        <span
          aria-hidden
          className="flex size-6 shrink-0 items-center justify-center rounded-md bg-[var(--surface-hover)] text-xs font-semibold text-[color:var(--accent)]"
        >
        ...
        <span className="min-w-0 flex-1">
          ...
          <span
            ...
            className={cn(
              'block truncate text-[11px] text-[color:var(--text-muted)]',
