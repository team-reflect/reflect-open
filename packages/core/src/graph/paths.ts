...
/**
 * Classify a graph-relative path using the cross-platform discovery policy.
 * Notes require an exactly lowercase `.md` suffix. Attachments match their
 * extension case-insensitively. Hidden, absolute, and traversal paths fail
 * closed, while Markdown may otherwise live at the root or any depth.
 */
...
/** Is this graph-relative path an eligible Markdown note? */
