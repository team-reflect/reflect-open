...
| 24 | [Quick Note Intent](24-quick-note-intent.md) | Siri, Shortcuts and Action button capture into Daily notes |
| 25 | [X capture](25-x-capture.md) | Manual post snapshots and opt-in bookmark/like capture through the existing inbox |
